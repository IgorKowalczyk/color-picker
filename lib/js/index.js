...
class cookieconsent {
constructor() {
this.cookiewrapper = document.querySelector(".cookie-wrapper");
this.cookieconsentjs = document.querySelector(".cookie-consent");
this.cookieconsentjsBtn = document.querySelector(".cookie-consent-btn");
this.c = cookie();
this.initListeners();
this.render();
}
initListeners() {
this.cookieconsentjsBtn.addEventListener("click", () => {
this.cookiewrapper.style.transform = `translateY(-${this.cookieconsentjs
.offsetHeight}px)`;
this.c.setCookie("cookieconsentjs", "true", 1000);
});
window.addEventListener("resize", () => {
this.render();
});
}
render() { this.cookiewrapper.classList.add("notransition");
if (this.c.getCookie("cookieconsentjs")) {
this.cookiewrapper.style.transform = `translateY(-${this.cookieconsentjs
.offsetHeight}1px)`;
}
this.cookiewrapper.offsetHeight; this.cookiewrapper.classList.remove("notransition");
}
}
const cookieconsentjs = new cookieconsent();